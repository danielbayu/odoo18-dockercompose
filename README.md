...
``` bash
curl -s https://raw.githubusercontent.com/danielbayu/odoo18-dockercompose/master/run.sh | bash -s odoo-one 10018 20018
```
and/or run the following to set up another Odoo instance @ `localhost:11018` (default master password: `*#Oke123#*`):

``` bash
curl -s https://raw.githubusercontent.com/danielbayu/odoo18-dockercompose/master/run.sh | bash -s odoo-two 11018 21018
```
